...
import 'package:trackgo_driver/features/home/data/datasources/firebase_driver_data_source.dart';
...
class FirebaseDriverRepository implements DriverRepository {
  final FirebaseDriverDataSource _dataSource;

  FirebaseDriverRepository({FirebaseDriverDataSource? dataSource})
    : _dataSource = dataSource ?? FirebaseDriverDataSource();
